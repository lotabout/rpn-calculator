...
public class RegexTokenizerTest {
    ...
    public void lineShouldBeTokenized() {
        List<OperatorReader<Integer>> readers = Arrays.asList(new SeparatorReader(), new NumberReader());
    ...
    private static abstract class MockReader implements OperatorReader<Integer> {
        @Override
